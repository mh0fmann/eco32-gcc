...
# define DO_TEST 0
#elif defined (__ECO32__) && !defined(__linux__)
  /* ECO32 divisions do trap, but libgloss targets do not
     intercept the trap and raise a SIGFPE. So restrict
     the test to systems that use the Linux kernel.  */
# define DO_TEST 0
